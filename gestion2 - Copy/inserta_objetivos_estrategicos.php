...
$sql="insert into gestion_obj_estrategicos (codigo, nombre, descripcion, codigo_plan_estrategico,completados,tiempo_ejecucion) value ('$codigo','$nombre', '$descripcion', '$direccion','0','0')";
