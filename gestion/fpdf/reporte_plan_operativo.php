...
function Header()
{
	...
	//Logo
	$this->Image('../../imgs/encabezado.png',20,20,70);
	//Arial bold 15
	$this->SetFont('Arial','B',10);
	//Movernos a la derecha
	$this->Cell(60);
	//Título
	$this->Cell(60,80,'LISTADO DE PLANES OPERATIVOS - DIRECCION',0,1,'C');
	//Salto de línea
	$this->Ln(1);
}
...
$result=mysql_query("select * from gestion.gestion_planes_operativos where cod_direccion=$_GET[seleccionado]",$link);

	//Salto de línea
	$pdf->Ln(-36);
	
    $pdf->Cell(35); //especifica margen
