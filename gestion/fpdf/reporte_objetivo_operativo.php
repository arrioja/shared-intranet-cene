...
function Header()
{
	...
	$this->Cell(60);
	//Título
	$this->Cell(60,80,'LISTADO DE OBJETIVOS OPERATIVOS - DIRECCION',0,1,'C');
	//Salto de línea
	$this->Ln(1);
}
...
$result=mysql_query("select * from gestion_obj_operativos where cod_plan_o_dir=$_GET[seleccionado]",$link);
