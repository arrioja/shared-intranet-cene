...
function Header()
{
	...
	$this->Cell(60);
	//Título
	$this->Cell(60,80,'LISTADO DE OBJETIVOS ESTRATEGICOS - ORGANIZACION',0,1,'C');
	//Salto de línea
	$this->Ln(1);
}
...
$result=mysql_query("select * from gestion_obj_estrategicos where codigo_plan_estrategico=$_GET[seleccionado]",$link);
