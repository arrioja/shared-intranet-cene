...
function Header()
{
	...
	$this->Cell(60);
	//Título
	$this->Cell(78,80,'LISTADO DE ACTIVIDADES',0,1,'C');
	//Salto de línea
	$this->Ln(1);
}
...
$result=mysql_query("select * from gestion_actividades WHERE cod_plan_operativo=$_GET[seleccionado]",$link);
