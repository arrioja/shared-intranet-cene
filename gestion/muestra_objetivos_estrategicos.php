...
<body>
  <table width="600" border="1" align="center" cellpadding="0" cellspacing="0">
    ...
    <tr>
      ...
      <td class="datos_formularios"><div align="center"><a href="modifica_objetivos_estrategicos.php?seleccionado=<?php echo $row[1]?>"><img src="../imgs/edit.png" width="16" height="16" border="0" title="Editar Objetivo" /></a></div></td>
      <td class="datos_formularios"><div align="center"><img style="CURSOR: pointer" src="../imgs/delete.png" width="16" height="16" title="Eliminar Objetivo" onclick="confirma_eliminar('<?php echo $row[1];?>','<?php echo $row[2]?>')"/></div></td>
    </tr>
    <?php }?>
  </table>
  <div align="center">
