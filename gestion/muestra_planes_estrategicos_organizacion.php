...
<title>Indicadores Planes Estrat&eacute;gicos Direcciones</title></head>
...
<form id="form1" name="form1" method="post" action="">
    ...
    <tr>
      ...
      <td width="374"><div align="center"><strong>Nombre</strong></div></td>
      <td width="78"><strong> <div align="center"><strong>Indicadores</strong></div></td>
    </tr> 
    <?php while ($row=mysql_fetch_array($result)){?>
    <tr>
      <td height="43"><div align="center"><?php echo $row["codigo"] ?></div>      </td>
      <td><div align="center"><?php echo $row['nombre'] ?></div>      </td>
      <td><div align="center"><a href="barra_planes_organizacion.php?seleccionado=<?php echo $row["codigo"] ?>"><img src="../imgs/log.png" width="24" height="24" border="0"  title="Ver Gr&aacute;ficas"/></a></div></td>
      </tr>
    <?php }?>
  </table>
