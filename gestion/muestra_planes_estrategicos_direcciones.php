...
<body>
  ...
  $result=mysql_query("select * from gestion.gestion_planes_estrategicos_direcciones where cod_direccion=$_GET[seleccionado]",$link);
?>
      <br />     
      ...
      <td width="59" class="encabezado_formularios">Eliminar</td>    
        ...
        <td class="datos_formularios"><div align="center"><img style="cursor:pointer" src="../imgs/delete.png" width="16" height="16" title="Eliminar Plan" onclick="confirma_eliminar('<?php echo $row[1];?>','<?php echo $row[2]?>')" /></div></td>
      </tr>
          <?php }?>
        </table>
        <div align="center">
          <p>
            ...
            <a href="../fpdf/reporte_plan_direccion.php?seleccionado=<?php echo $_GET['seleccionado'] ?>"><img src="../imgs/printer.png"  border="0" title="Imprimir"/></a>
