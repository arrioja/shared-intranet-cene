...
-- 
-- Servidor: localhost
-- Tiempo de generación: 07-01-2008 a las 11:25:13
...
INSERT INTO `conceptos` VALUES ('0005', 'Ley de Vivienda y Habitat', 'DEBITO', 'y(ta)=ta*0.01', '1', 'QUINCENAL', 56);
...
INSERT INTO `conceptos` VALUES ('9001', 'R.I.S.L.R.', 'DEBITO', 'y(ta,pct)=ta*(pct/100)', '0', 'QUINCENAL', 67);
...
INSERT INTO `conceptos` VALUES ('0010', 'Poliza HCM', 'DEBITO', 'y(hcm)=hcm/2', '0', 'QUINCENAL', 72);
INSERT INTO `conceptos` VALUES ('0011', 'Ajuste poliza HCM', 'DEBITO', 'y(ahc)=ahc/2', '0', 'QUINCENAL', 73);
...
INSERT INTO `conceptos` VALUES ('0014', ' S.S.O. y Reg. Prest. Empleo 2', 'DEBITO', 'y(sm)=(2328750*12/52)*0.045*4/2', '0', 'QUINCENAL', 76);
...
INSERT INTO `integrantes_constantes` VALUES (190, 13023459, '0005', 100000);
...
INSERT INTO `integrantes_constantes` VALUES (208, 5482594, '0005', 100000);
INSERT INTO `integrantes_constantes` VALUES (209, 5482594, '0003', 230120.2);
INSERT INTO `integrantes_constantes` VALUES (210, 5482594, '0017', 229064.2);
INSERT INTO `integrantes_constantes` VALUES (211, 9429622, '0005', 100000);
...
CREATE TABLE `nomina` (
  ...
  `tipo_nomina` varchar(20) default NULL,
  PRIMARY KEY  (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=latin1 AUTO_INCREMENT=1532 ;

-- 
-- Volcar la base de datos para la tabla `nomina`
-- 

INSERT INTO `nomina` VALUES ('0001', 6966895, '0001', 'Bono de Antiguedad', 35000, 'CREDITO', 1417, 'DIRECTORES');
INSERT INTO `nomina` VALUES ('0001', 6966895, '0008', 'Prima Profesionales', 60000, 'CREDITO', 1418, 'DIRECTORES');
INSERT INTO `nomina` VALUES ('0001', 6966895, '1000', 'Sueldo Quincenal', 2315510.75, 'CREDITO', 1419, 'DIRECTORES');
INSERT INTO `nomina` VALUES ('0001', 6966895, '7001', 'Total Asignaciones', 2410510.75, 'ASIGNACION', 1420, 'DIRECTORES');
INSERT INTO `nomina` VALUES ('0001', 6966895, '0002', 'Prestamos', 305673, 'DEBITO', 1421, 'DIRECTORES');
INSERT INTO `nomina` VALUES ('0001', 6966895, '0003', 'Fondo de Jubilacion y Pension', 69465.32, 'DEBITO', 1422, 'DIRECTORES');
INSERT INTO `nomina` VALUES ('0001', 6966895, '0004', 'CACOENE', 463102.15, 'DEBITO', 1423, 'DIRECTORES');
INSERT INTO `nomina` VALUES ('0001', 6966895, '0005', 'Ley de Vivienda y Habitat', 24105.1, 'DEBITO', 1424, 'DIRECTORES');
INSERT INTO `nomina` VALUES ('0001', 6966895, '0010', 'Poliza HCM', 78907.1, 'DEBITO', 1425, 'DIRECTORES');
INSERT INTO `nomina` VALUES ('0001', 6966895, '0011', 'Ajuste poliza HCM', 6408.89, 'DEBITO', 1426, 'DIRECTORES');
INSERT INTO `nomina` VALUES ('0001', 6966895, '0014', ' S.S.O. y Reg. Prest. Empleo 2', 48366.34, 'DEBITO', 1427, 'DIRECTORES');
INSERT INTO `nomina` VALUES ('0001', 6966895, '9001', 'R.I.S.L.R.', 82921.57, 'DEBITO', 1428, 'DIRECTORES');
INSERT INTO `nomina` VALUES ('0001', 6966895, '7002', 'Total Deducciones', 1078949.48, 'DEDUCCION', 1429, 'DIRECTORES');
INSERT INTO `nomina` VALUES ('0001', 6966895, '7003', 'Total Neto', 1331561.27, 'NETO', 1430, 'DIRECTORES');
INSERT INTO `nomina` VALUES ('0001', 4650716, '0001', 'Bono de Antiguedad', 115000, 'CREDITO', 1431, 'DIRECTORES');
INSERT INTO `nomina` VALUES ('0001', 4650716, '0008', 'Prima Profesionales', 60000, 'CREDITO', 1432, 'DIRECTORES');
INSERT INTO `nomina` VALUES ('0001', 4650716, '0012', 'Prima Jerarquia y Responsabilidad', 125000, 'CREDITO', 1433, 'DIRECTORES');
INSERT INTO `nomina` VALUES ('0001', 4650716, '0013', 'Comp. Gastos Repres.', 175000, 'CREDITO', 1434, 'DIRECTORES');
INSERT INTO `nomina` VALUES ('0001', 4650716, '1000', 'Sueldo Quincenal', 2973953.12, 'CREDITO', 1435, 'DIRECTORES');
INSERT INTO `nomina` VALUES ('0001', 4650716, '7001', 'Total Asignaciones', 3448953.12, 'ASIGNACION', 1436, 'DIRECTORES');
INSERT INTO `nomina` VALUES ('0001', 4650716, '0003', 'Fondo de Jubilacion y Pension', 89218.59, 'DEBITO', 1437, 'DIRECTORES');
INSERT INTO `nomina` VALUES ('0001', 4650716, '0004', 'CACOENE', 594790.62, 'DEBITO', 1438, 'DIRECTORES');
INSERT INTO `nomina` VALUES ('0001', 4650716, '0005', 'Ley de Vivienda y Habitat', 34489.53, 'DEBITO', 1439, 'DIRECTORES');
INSERT INTO `nomina` VALUES ('0001', 4650716, '0010', 'Poliza HCM', 273267.74, 'DEBITO', 1440, 'DIRECTORES');
INSERT INTO `nomina` VALUES ('0001', 4650716, '0014', ' S.S.O. y Reg. Prest. Empleo 2', 48366.34, 'DEBITO', 1441, 'DIRECTORES');
INSERT INTO `nomina` VALUES ('0001', 4650716, '9001', 'R.I.S.L.R.', 290401.85, 'DEBITO', 1442, 'DIRECTORES');
INSERT INTO `nomina` VALUES ('0001', 4650716, '7002', 'Total Deducciones', 1330534.68, 'DEDUCCION', 1443, 'DIRECTORES');
INSERT INTO `nomina` VALUES ('0001', 4650716, '7003', 'Total Neto', 2118418.43, 'NETO', 1444, 'DIRECTORES');
INSERT INTO `nomina` VALUES ('0001', 6177583, '0001', 'Bono de Antiguedad', 70000, 'CREDITO', 1445, 'DIRECTORES');
INSERT INTO `nomina` VALUES ('0001', 6177583, '0008', 'Prima Profesionales', 50000, 'CREDITO', 1446, 'DIRECTORES');
INSERT INTO `nomina` VALUES ('0001', 6177583, '1000', 'Sueldo Quincenal', 2231310.36, 'CREDITO', 1447, 'DIRECTORES');
INSERT INTO `nomina` VALUES ('0001', 6177583, '7001', 'Total Asignaciones', 2351310.36, 'ASIGNACION', 1448, 'DIRECTORES');
INSERT INTO `nomina` VALUES ('0001', 6177583, '0003', 'Fondo de Jubilacion y Pension', 66939.31, 'DEBITO', 1449, 'DIRECTORES');
INSERT INTO `nomina` VALUES ('0001', 6177583, '0005', 'Ley de Vivienda y Habitat', 23513.1, 'DEBITO', 1450, 'DIRECTORES');
INSERT INTO `nomina` VALUES ('0001', 6177583, '0014', ' S.S.O. y Reg. Prest. Empleo 2', 48366.34, 'DEBITO', 1451, 'DIRECTORES');
INSERT INTO `nomina` VALUES ('0001', 6177583, '9001', 'R.I.S.L.R.', 69598.78, 'DEBITO', 1452, 'DIRECTORES');
INSERT INTO `nomina` VALUES ('0001', 6177583, '7002', 'Total Deducciones', 208417.54, 'DEDUCCION', 1453, 'DIRECTORES');
INSERT INTO `nomina` VALUES ('0001', 6177583, '7003', 'Total Neto', 2142892.81, 'NETO', 1454, 'DIRECTORES');
INSERT INTO `nomina` VALUES ('0001', 6122659, '0001', 'Bono de Antiguedad', 45000, 'CREDITO', 1455, 'DIRECTORES');
INSERT INTO `nomina` VALUES ('0001', 6122659, '0008', 'Prima Profesionales', 50000, 'CREDITO', 1456, 'DIRECTORES');
INSERT INTO `nomina` VALUES ('0001', 6122659, '0009', 'Prima de Responsabilidad', 100000, 'CREDITO', 1457, 'DIRECTORES');
INSERT INTO `nomina` VALUES ('0001', 6122659, '1000', 'Sueldo Quincenal', 2504456.44, 'CREDITO', 1458, 'DIRECTORES');
INSERT INTO `nomina` VALUES ('0001', 6122659, '7001', 'Total Asignaciones', 2699456.44, 'ASIGNACION', 1459, 'DIRECTORES');
INSERT INTO `nomina` VALUES ('0001', 6122659, '0002', 'Prestamos', 407881, 'DEBITO', 1460, 'DIRECTORES');
INSERT INTO `nomina` VALUES ('0001', 6122659, '0003', 'Fondo de Jubilacion y Pension', 75133.69, 'DEBITO', 1461, 'DIRECTORES');
INSERT INTO `nomina` VALUES ('0001', 6122659, '0004', 'CACOENE', 500891.28, 'DEBITO', 1462, 'DIRECTORES');
INSERT INTO `nomina` VALUES ('0001', 6122659, '0005', 'Ley de Vivienda y Habitat', 26994.56, 'DEBITO', 1463, 'DIRECTORES');
INSERT INTO `nomina` VALUES ('0001', 6122659, '0014', ' S.S.O. y Reg. Prest. Empleo 2', 48366.34, 'DEBITO', 1464, 'DIRECTORES');
INSERT INTO `nomina` VALUES ('0001', 6122659, '9001', 'R.I.S.L.R.', 132813.25, 'DEBITO', 1465, 'DIRECTORES');
INSERT INTO `nomina` VALUES ('0001', 6122659, '7002', 'Total Deducciones', 1192080.14, 'DEDUCCION', 1466, 'DIRECTORES');
INSERT INTO `nomina` VALUES ('0001', 6122659, '7003', 'Total Neto', 1507376.29, 'NETO', 1467, 'DIRECTORES');
INSERT INTO `nomina` VALUES ('0001', 13023459, '0001', 'Bono de Antiguedad', 35000, 'CREDITO', 1468, 'DIRECTORES');
INSERT INTO `nomina` VALUES ('0001', 13023459, '0008', 'Prima Profesionales', 50000, 'CREDITO', 1469, 'DIRECTORES');
INSERT INTO `nomina` VALUES ('0001', 13023459, '1000', 'Sueldo Quincenal', 2315510.75, 'CREDITO', 1470, 'DIRECTORES');
INSERT INTO `nomina` VALUES ('0001', 13023459, '7001', 'Total Asignaciones', 2400510.75, 'ASIGNACION', 1471, 'DIRECTORES');
INSERT INTO `nomina` VALUES ('0001', 13023459, '0002', 'Prestamos', 455571, 'DEBITO', 1472, 'DIRECTORES');
INSERT INTO `nomina` VALUES ('0001', 13023459, '0003', 'Fondo de Jubilacion y Pension', 69465.32, 'DEBITO', 1473, 'DIRECTORES');
INSERT INTO `nomina` VALUES ('0001', 13023459, '0004', 'CACOENE', 463102.15, 'DEBITO', 1474, 'DIRECTORES');
INSERT INTO `nomina` VALUES ('0001', 13023459, '0005', 'Ley de Vivienda y Habitat', 24005.1, 'DEBITO', 1475, 'DIRECTORES');
INSERT INTO `nomina` VALUES ('0001', 13023459, '0010', 'Poliza HCM', 78907.1, 'DEBITO', 1476, 'DIRECTORES');
INSERT INTO `nomina` VALUES ('0001', 13023459, '0011', 'Ajuste poliza HCM', 6408.89, 'DEBITO', 1477, 'DIRECTORES');
INSERT INTO `nomina` VALUES ('0001', 13023459, '0014', ' S.S.O. y Reg. Prest. Empleo 2', 48366.34, 'DEBITO', 1478, 'DIRECTORES');
INSERT INTO `nomina` VALUES ('0001', 13023459, '9001', 'R.I.S.L.R.', 95780.37, 'DEBITO', 1479, 'DIRECTORES');
INSERT INTO `nomina` VALUES ('0001', 13023459, '7002', 'Total Deducciones', 1241606.29, 'DEDUCCION', 1480, 'DIRECTORES');
INSERT INTO `nomina` VALUES ('0001', 13023459, '7003', 'Total Neto', 1158904.46, 'NETO', 1481, 'DIRECTORES');
INSERT INTO `nomina` VALUES ('0001', 5482594, '0001', 'Bono de Antiguedad', 35000, 'CREDITO', 1482, 'DIRECTORES');
INSERT INTO `nomina` VALUES ('0001', 5482594, '0008', 'Prima Profesionales', 50000, 'CREDITO', 1483, 'DIRECTORES');
INSERT INTO `nomina` VALUES ('0001', 5482594, '1000', 'Sueldo Quincenal', 2413385.29, 'CREDITO', 1484, 'DIRECTORES');
INSERT INTO `nomina` VALUES ('0001', 5482594, '7001', 'Total Asignaciones', 2498385.29, 'ASIGNACION', 1485, 'DIRECTORES');
INSERT INTO `nomina` VALUES ('0001', 5482594, '0002', 'Prestamos', 405636, 'DEBITO', 1486, 'DIRECTORES');
INSERT INTO `nomina` VALUES ('0001', 5482594, '0003', 'Fondo de Jubilacion y Pension', 72401.55, 'DEBITO', 1487, 'DIRECTORES');
INSERT INTO `nomina` VALUES ('0001', 5482594, '0004', 'CACOENE', 482677.05, 'DEBITO', 1488, 'DIRECTORES');
INSERT INTO `nomina` VALUES ('0001', 5482594, '0005', 'Ley de Vivienda y Habitat', 24983.85, 'DEBITO', 1489, 'DIRECTORES');
INSERT INTO `nomina` VALUES ('0001', 5482594, '0010', 'Poliza HCM', 115060.1, 'DEBITO', 1490, 'DIRECTORES');
INSERT INTO `nomina` VALUES ('0001', 5482594, '0011', 'Ajuste poliza HCM', 114532.1, 'DEBITO', 1491, 'DIRECTORES');
INSERT INTO `nomina` VALUES ('0001', 5482594, '0014', ' S.S.O. y Reg. Prest. Empleo 2', 48366.34, 'DEBITO', 1492, 'DIRECTORES');
INSERT INTO `nomina` VALUES ('0001', 5482594, '9001', 'R.I.S.L.R.', 99185.89, 'DEBITO', 1493, 'DIRECTORES');
INSERT INTO `nomina` VALUES ('0001', 5482594, '7002', 'Total Deducciones', 1362842.91, 'DEDUCCION', 1494, 'DIRECTORES');
INSERT INTO `nomina` VALUES ('0001', 5482594, '7003', 'Total Neto', 1135542.38, 'NETO', 1495, 'DIRECTORES');
INSERT INTO `nomina` VALUES ('0001', 5605331, '0001', 'Bono de Antiguedad', 40000, 'CREDITO', 1496, 'DIRECTORES');
INSERT INTO `nomina` VALUES ('0001', 5605331, '0008', 'Prima Profesionales', 60000, 'CREDITO', 1497, 'DIRECTORES');
INSERT INTO `nomina` VALUES ('0001', 5605331, '1000', 'Sueldo Quincenal', 2273410.56, 'CREDITO', 1498, 'DIRECTORES');
INSERT INTO `nomina` VALUES ('0001', 5605331, '7001', 'Total Asignaciones', 2373410.56, 'ASIGNACION', 1499, 'DIRECTORES');
INSERT INTO `nomina` VALUES ('0001', 5605331, '0002', 'Prestamos', 174374, 'DEBITO', 1500, 'DIRECTORES');
INSERT INTO `nomina` VALUES ('0001', 5605331, '0003', 'Fondo de Jubilacion y Pension', 68202.31, 'DEBITO', 1501, 'DIRECTORES');
INSERT INTO `nomina` VALUES ('0001', 5605331, '0004', 'CACOENE', 454682.11, 'DEBITO', 1502, 'DIRECTORES');
INSERT INTO `nomina` VALUES ('0001', 5605331, '0005', 'Ley de Vivienda y Habitat', 23734.1, 'DEBITO', 1503, 'DIRECTORES');
INSERT INTO `nomina` VALUES ('0001', 5605331, '0014', ' S.S.O. y Reg. Prest. Empleo 2', 48366.34, 'DEBITO', 1504, 'DIRECTORES');
INSERT INTO `nomina` VALUES ('0001', 5605331, '9001', 'R.I.S.L.R.', 102293.99, 'DEBITO', 1505, 'DIRECTORES');
INSERT INTO `nomina` VALUES ('0001', 5605331, '7002', 'Total Deducciones', 871652.87, 'DEDUCCION', 1506, 'DIRECTORES');
INSERT INTO `nomina` VALUES ('0001', 5605331, '7003', 'Total Neto', 1501757.68, 'NETO', 1507, 'DIRECTORES');
INSERT INTO `nomina` VALUES ('0001', 13729622, '0001', 'Bono de Antiguedad', 35000, 'CREDITO', 1508, 'DIRECTORES');
INSERT INTO `nomina` VALUES ('0001', 13729622, '0008', 'Prima Profesionales', 50000, 'CREDITO', 1509, 'DIRECTORES');
INSERT INTO `nomina` VALUES ('0001', 13729622, '1000', 'Sueldo Quincenal', 2504456.44, 'CREDITO', 1510, 'DIRECTORES');
INSERT INTO `nomina` VALUES ('0001', 13729622, '7001', 'Total Asignaciones', 2589456.44, 'ASIGNACION', 1511, 'DIRECTORES');
INSERT INTO `nomina` VALUES ('0001', 13729622, '0002', 'Prestamos', 384732, 'DEBITO', 1512, 'DIRECTORES');
INSERT INTO `nomina` VALUES ('0001', 13729622, '0003', 'Fondo de Jubilacion y Pension', 75133.69, 'DEBITO', 1513, 'DIRECTORES');
INSERT INTO `nomina` VALUES ('0001', 13729622, '0004', 'CACOENE', 500891.28, 'DEBITO', 1514, 'DIRECTORES');
INSERT INTO `nomina` VALUES ('0001', 13729622, '0005', 'Ley de Vivienda y Habitat', 25894.56, 'DEBITO', 1515, 'DIRECTORES');
INSERT INTO `nomina` VALUES ('0001', 13729622, '0014', ' S.S.O. y Reg. Prest. Empleo 2', 48366.34, 'DEBITO', 1516, 'DIRECTORES');
INSERT INTO `nomina` VALUES ('0001', 13729622, '9001', 'R.I.S.L.R.', 141125.37, 'DEBITO', 1517, 'DIRECTORES');
INSERT INTO `nomina` VALUES ('0001', 13729622, '7002', 'Total Deducciones', 1176143.26, 'DEDUCCION', 1518, 'DIRECTORES');
INSERT INTO `nomina` VALUES ('0001', 13729622, '7003', 'Total Neto', 1413313.17, 'NETO', 1519, 'DIRECTORES');
INSERT INTO `nomina` VALUES ('0001', 9429622, '0001', 'Bono de Antiguedad', 60000, 'CREDITO', 1520, 'DIRECTORES');
INSERT INTO `nomina` VALUES ('0001', 9429622, '0008', 'Prima Profesionales', 50000, 'CREDITO', 1521, 'DIRECTORES');
INSERT INTO `nomina` VALUES ('0001', 9429622, '1000', 'Sueldo Quincenal', 2408131.18, 'CREDITO', 1522, 'DIRECTORES');
INSERT INTO `nomina` VALUES ('0001', 9429622, '7001', 'Total Asignaciones', 2518131.18, 'ASIGNACION', 1523, 'DIRECTORES');
INSERT INTO `nomina` VALUES ('0001', 9429622, '0002', 'Prestamos', 423344, 'DEBITO', 1524, 'DIRECTORES');
INSERT INTO `nomina` VALUES ('0001', 9429622, '0003', 'Fondo de Jubilacion y Pension', 72243.93, 'DEBITO', 1525, 'DIRECTORES');
INSERT INTO `nomina` VALUES ('0001', 9429622, '0004', 'CACOENE', 481626.23, 'DEBITO', 1526, 'DIRECTORES');
INSERT INTO `nomina` VALUES ('0001', 9429622, '0005', 'Ley de Vivienda y Habitat', 25181.31, 'DEBITO', 1527, 'DIRECTORES');
INSERT INTO `nomina` VALUES ('0001', 9429622, '0014', ' S.S.O. y Reg. Prest. Empleo 2', 48366.34, 'DEBITO', 1528, 'DIRECTORES');
INSERT INTO `nomina` VALUES ('0001', 9429622, '9001', 'R.I.S.L.R.', 108279.64, 'DEBITO', 1529, 'DIRECTORES');
INSERT INTO `nomina` VALUES ('0001', 9429622, '7002', 'Total Deducciones', 1159041.47, 'DEDUCCION', 1530, 'DIRECTORES');
INSERT INTO `nomina` VALUES ('0001', 9429622, '7003', 'Total Neto', 1359089.71, 'NETO', 1531, 'DIRECTORES');
