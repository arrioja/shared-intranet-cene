    <html>
        ...
        $sc_ajax_select_boxes->add_select_box('descripcion_presupuesto','id','ano','id',2,'sel1','sel_id_1','');
        $sc_ajax_select_boxes->add_radio_box('descripcion_presupuesto','id','ano','id',10,'sel2','sel_id_2','ano');
        $sc_ajax_select_boxes->add_radio_box('descripcion_presupuesto','id','ano','id',43,'sel3','sel_id_3','');
